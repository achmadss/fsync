...
import dev.achmad.fsync.util.clearFocusOnSoftKeyboardHide
import dev.achmad.fsync.util.runOnEnterKeyPressed
import dev.achmad.fsync.util.secondaryItemAlpha
import dev.achmad.fsync.util.showSoftKeyboard
                    ...
                    TextFieldDefaults.DecorationBox(
                        ...
                        placeholder = {
                            Text(
                                ...
                                text = (placeholderText ?: stringResource(R.string.search_placeholder)),
                                maxLines = 1,
                                overflow = TextOverflow.Ellipsis,
